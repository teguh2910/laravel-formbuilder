    <div id="view-track" class="page-wrap hidden">
        ...
        <div class="container">
            <div class="card" style="max-width:760px;margin:0 auto;">
                ...
                <form id="form-track-search" method="GET" action="{{ '/' . trim((string) config('formbuilder.route_prefix', 'formbuilder'), '/') . '/track' }}" style="display:flex;gap:8px;margin-bottom:14px;">
